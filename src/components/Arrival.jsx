    ...
    return (
        <section className="container">
            <div className="py-[30px] tablet:py-[50px] sm-tablet:py-[100px]">
                <h1 className="text-5xl font-bold text-center leading-[1.3em] pb-10">New Arrivals</h1>
                <div className="grid grid-cols-1 sm-mobile:grid-cols-2 tablet:grid-cols-3 sm-tablet:grid-cols-4 gap-[20px]">
                    <div>
                        ...
                        <Link href={"/product"} className="block text-[15px]! font-bold! leading-[1.3em] mb-2 text-black">Hanging Plant</Link>
                    ...
                    <div>
                        ...
                        <Link href={"/product"} className="block text-[15px]! font-bold! leading-[1.3em] mb-2 text-black">Wooden Vases</Link>
                    ...
                    <div>
                        ...
                        <Link href={"/product"} className="block text-[15px]! font-bold! leading-[1.3em] text-black  mb-2">Golden Lamps</Link>
                    ...
                    <div>
                        ...
                        <Link href={"/product"} className="block text-[15px]! font-bold! leading-[1.3em] mb-2 text-black">Wooden Greenery</Link>

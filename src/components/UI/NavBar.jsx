        ...
        <header className="bg-white">
            <div className="max-w-[1240px] px-0 sm-tablet:px-[15px] mx-auto">
                <div className="flex items-center justify-between flex-wrap sm-tablet:flex-nowrap py-2.5">
                    <Link className="order-1 w-[50%] sm-tablet:w-auto sm-tablet:order-none pl-[15px] sm-tablet:px-0" href={"/home"}>
                    ...
                    {state &&
                        <ul className="order-3 w-[100%] sm-tablet:w-auto sm-tablet:order-none flex items-start sm-tablet:items-center justify-center gap-1.5 sm-tablet:gap-8 flex-col sm-tablet:flex-row mt-2.5 pl-[15px] sm-tablet:px-0 bg-[#f9f9f9] sm-tablet:bg-transparent">
                            <li>
                                <Link href={"/all-product"} className="text-primary sm-tablet:text-[#000] leading-normal sm-tablet:leading-[70px] transition duration-200 ease-linear hover:text-primary">All Products</Link>
                            </li>
                            <li>
                                <Link href={"/home-decor"} className="text-primary sm-tablet:text-[#000] leading-normal sm-tablet:leading-[70px] transition duration-200 ease-linear hover:text-primary">Home Decor</Link>
                            </li>
                            <li>
                                <Link href={"/garden-decor"} className="text-primary sm-tablet:text-[#000] leading-normal sm-tablet:leading-[70px] transition duration-200 ease-linear hover:text-primary">Garden Decor</Link>
                            </li>
                            <li>
                                <Link href={"/about-us"} className="text-primary sm-tablet:text-[#000] leading-normal sm-tablet:leading-[70px] transition duration-200 ease-linear hover:text-primary">About</Link>
                            </li>
                            <li>
                                <Link href={"/contact"} className="text-primary sm-tablet:text-[#000] leading-normal sm-tablet:leading-[70px] transition duration-200 ease-linear hover:text-primary">Contact</Link>
                            </li>
                        </ul>
                    }
                    <div className="hidden sm-tablet:flex items-center justify-center gap-5">
                        <div className="h-[36px] w-[36px] flex items-center justify-center relative border-2 border-solid border-black cursor-pointer group">
                            ...
                            <div className="w-[280px] bg-white border border-solid border-[#dddddd] absolute top-[110%] right-0 left-auto cursor-default transition duration-200 ease-in invisible opacity-0 group-hover:visible group-hover:opacity-[1] z-[1]">
                                ...
                                <Link href={"/all-product"} className="flex items-center justify-center font-bold capitalize text-primary border border-solid border-primary m-[18px] px-[30px] py-[15px] leading-[1em] cursor-pointer hover:bg-primary hover:text-white transition duration-200 ease-in ">Continue Shopping</Link>
                            </div>
                        </div>

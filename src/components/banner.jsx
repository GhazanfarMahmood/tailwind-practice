        ...
        <div className="max-w-[1530px] px-[15px] tablet:px-[40px] laptop:px-[15px] py-[50px_100px] mx-auto gap-5 relative">
            <div className="flex items-center flex-col laptop:flex-row justify-center gap-5 laptop:gap-0">
                <div className="mt-0 laptop:max-[1400px]:mt-[112px] w-full laptop:w-[44%] bg-primary p-[30px_25px] mobile:p-[50px_40px] relative z-[2]">
                    ...
                    <Link href={"/product"} className="w-fit flex items-center justify-center bg-white text-black font-secondary font-semibold uppercase p-[10px_30px] border border-solid border-white cursor-pointer transition duration-200 ease-in hover:bg-transparent hover:text-white mx-auto laptop:mx-0 ">Shop Now</Link>
                </div>
            ...
            <a href="#info" className="w-fit h-fit d-flex items-center justify-center absolute inset-0 mt-auto  ml-auto mb-[60px] mr-5 mobile:max-[1600px]:mr-[53px]  bg-primary p-[16px_22px] mobile:p-[29px_35px]" >
